...
import EmailVerifyFunctionality from "./EmailVerifyFunctionality";

const EmailVerify = () => {
    const { otp,email,handleChange,handleKeyDown,handlePaste,inputRefs,isLoading,formatTime,timer,message,verifyOtp,resendOtp} = EmailVerifyFunctionality();
