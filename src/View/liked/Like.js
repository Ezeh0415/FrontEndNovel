...
const Like = () => {
  const { liked, LikedLoading, LikedError } = useMyContext();
  return (
    <div>
            ...
            liked.map((like) => {
              return (
                <div className="md:flex">
                  <img
                    className="object-cover w-full h-48 md:w-48 rounded-xl"
                    src={like.image_url}
                    alt={like.title}
                  />
                  <div className="flex flex-col justify-between p-6">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      <button className="px-2 random-md text-white transition bg-yellow-600 rounded hover:bg-yellow-700">
                        <a
